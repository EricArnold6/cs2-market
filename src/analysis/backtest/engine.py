...
:func:`~src.analysis.strategy.signal.generate_signals` and tracks portfolio performance.
...
from src.analysis.strategy.signal import generate_signals
from src.analysis.backtest.models import Trade, BacktestResult
    ...
    **signal_kwargs,
    ...
    Args:
        ...
        **signal_kwargs: Extra keyword arguments forwarded to
                         :func:`~src.analysis.strategy.signal.generate_signals`.
